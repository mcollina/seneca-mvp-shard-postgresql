...
-- Name: shard1; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE shard1 WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'C' LC_CTYPE = 'C';


ALTER DATABASE shard1 OWNER TO postgres;
